...
public class RightNoteObjectHandler : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        rightButton.onClick.AddListener(SetArrowUnactivated);
    }
    ...
    private void SetArrowUnactivated()
    {
        ...
        var distance = Mathf.Abs(transform.position.y - rightButton.transform.position.y);
        switch (distance)
        {
            case <= 5:
