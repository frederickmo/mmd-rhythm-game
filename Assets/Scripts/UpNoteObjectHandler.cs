...
public class UpNoteObjectHandler : MonoBehaviour
{
    // private bool onTouchThisButton;
    public bool canBePressed;
    [FormerlySerializedAs("button")] public Button upButton;
    ...
    void Start()
    {
        ...
        upButton.onClick.AddListener(SetArrowUnactivated);
    }
    ...
    private void SetArrowUnactivated()
    {
        ...
        var distance = Mathf.Abs(transform.position.y - upButton.transform.position.y);
        switch (distance)
        {
            case <= 5:
